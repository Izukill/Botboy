...
import static Utilz.Constants.BotboyConstants.airAttack;
...
public class Boss extends Model {
    ...
    private BufferedImage img=LoadSave.getSpriteImage("/MetalKnight.png");
    ...
    public void renderBossHealthBar(Graphics g) {
        int barWidth = 300;  // Largura da barra
        int barHeight = 20;   // Altura da barra
        int x = (game_width / 2) - (barWidth / 2); // Centralizar no topo
        int y = 20; // Posição Y no topo

        // Cores da barra
        g.setColor(Color.DARK_GRAY);
        g.fillRect(x, y, barWidth, barHeight); // Fundo da barra
