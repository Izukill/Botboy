...
public class Fase extends JPanel implements Runnable {
    ...
    private int lvlTilesWide= LoadFase.getLevelData()[0].length;
    ...
    public void restartGame() {
        ...
        // Adicionar os listeners de teclado novamente
        addKeyListener(new TecladoInputs());
        setFocusable(true);
...
//    }
    ...
    public void renderBackground(Graphics g, int xLvlOffset){
        BufferedImage background= LoadFase.getSpriteImage("/background.png");
